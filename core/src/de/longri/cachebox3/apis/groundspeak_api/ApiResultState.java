...
public enum ApiResultState {
    ...
    IO(1), API_IS_UNAVAILABLE(-1), API_ERROR(-2), CONNECTION_TIMEOUT(-3), CANCELED(-4), UNKNOWN(0), MEMBERSHIP_TYPE_VALID(1), MEMBERSHIP_TYPE_INVALID(-5), EXPIRED_API_KEY(-6),
    MEMBERSHIP_TYPE_GUEST(1), MEMBERSHIP_TYPE_BASIC(2), MEMBERSHIP_TYPE_PREMIUM(3);
