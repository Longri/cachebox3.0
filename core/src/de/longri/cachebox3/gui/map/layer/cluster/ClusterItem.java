 ...
 */
public class ClusterItem implements ClusterInterface {
     ...
     */
    public ClusterItem(String title, String description, GeoPoint geoPoint) {
        this(null, title, description, geoPoint);
    }

    public ClusterItem(Object uid, String title, String description, GeoPoint geoPoint) {
        this.title = title;
