 ...
 */
public abstract class AbstractShowAction<T extends AbstractView> extends AbstractAction {

    private final Class<T> viewClass;

    public AbstractShowAction(Class<T> viewClass, boolean disabled, String name, int id) {
        super(disabled, name, id);
        this.viewClass = viewClass;
    }

    public AbstractShowAction(Class<T> viewClass, boolean disabled, String name, String nameExtention, int id) {
