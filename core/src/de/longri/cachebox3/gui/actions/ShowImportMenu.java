...
public class ShowImportMenu extends Menu {
    ...
    public ShowImportMenu() {
        ...
        addMenuItem("GCVoteRatings", null, () -> { SelectableImport.getInstance("moreImport", CB.getSkin().getMenuIcon.importIcon).importGCVote();}); // todo create icon: CB.getSkin().getMenuIcon.importGCVote
        addDivider(0);
