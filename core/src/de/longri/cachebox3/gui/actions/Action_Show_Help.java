 ...
 */
public class Action_Show_Help extends Action {
    final static org.slf4j.Logger log = LoggerFactory.getLogger(Action_Show_Help.class);
    ...
    public Sprite getIcon() {
        return CB.getSprite(IconNames.helpIcon.name());
    }
}
