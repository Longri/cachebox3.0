...
public final class GpsStatus {
	...
	public interface Listener {
		 ...
		 * </ul>
		 * When this method is called, the client should call {@link LocationManager#getGpsStatus} to get additional status information.
		 * 
		 * @param event
	...
	/**
	 * Used for receiving NMEA sentences from the GPS. NMEA 0183 is a standard for communicating with marine electronic devices and is a
	 * common method for receiving data from a GPS, typically over a serial port. See <a href="http://en.wikipedia.org/wiki/NMEA_0183">NMEA
