...
public abstract class AbstractWaypointDAO {
    ...
    public abstract boolean updateDatabase(Database database, AbstractWaypoint WP, boolean fireCacheListChangedEvent);
    ...
    public abstract void delete(Database database, AbstractWaypoint waypoint, boolean fireCacheListChangedEvent);

    public abstract void writeToDatabase(Database database, AbstractWaypoint wp, boolean fireCacheListChangedEvent);
}
