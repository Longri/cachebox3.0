...
public class Settings extends Settings_Skin {
    ...
    public static final SettingsAudio Approach = (SettingsAudio) Config.settingsList.addSetting(new SettingsAudio("Approach", SettingCategory.Sounds, NEVER, new Audio("data/sound/Approach.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB));
    public static final SettingsAudio GPS_lose = (SettingsAudio) Config.settingsList.addSetting(new SettingsAudio("GPS_lose", SettingCategory.Sounds, NEVER, new Audio("data/sound/GPS_lose.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB));
    public static final SettingsAudio GPS_fix = (SettingsAudio) Config.settingsList.addSetting(new SettingsAudio("GPS_fix", SettingCategory.Sounds, NEVER, new Audio("data/sound/GPS_Fix.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB));
    public static final SettingsAudio AutoResortSound = (SettingsAudio) Config.settingsList.addSetting(new SettingsAudio("AutoResortSound", SettingCategory.Sounds, NEVER, new Audio("data/sound/AutoResort.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB));
    public static final SettingsAudio GlobalVolume = (SettingsAudio) Config.settingsList.addSetting(new SettingsAudio("GlobalVolume", SettingCategory.Sounds, NEVER, new Audio("data/sound/Approach.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB));
