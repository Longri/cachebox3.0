...
public class Settings extends Settings_Skin {
    ...
    public static final SettingString Friends = (SettingString) SettingsList.addSetting(new SettingString("Friends", SettingCategory.Login, NEVER, "", SettingStoreType.Global, SettingUsage.ACB));
    ...
    public static final SettingBool DescriptionNoAttributes = (SettingBool) SettingsList.addSetting(new SettingBool("DescriptionNoAttributes", SettingCategory.Misc, NEVER, false, SettingStoreType.Global, SettingUsage.ACB));
    public static final SettingBool quickButtonLastShow = (SettingBool) SettingsList.addSetting(new SettingBool("quickButtonLastShow", SettingCategory.QuickList, NEVER, false, SettingStoreType.Global, SettingUsage.ACB));
    ...
    public static final SettingString quickButtonList = (SettingString) SettingsList.addSetting(new SettingString("quickButtonList", SettingCategory.QuickList, NEVER, "5,0,1,3,2", SettingStoreType.Global, SettingUsage.ACB));
    ...
    public static final SettingsAudio GPS_fix = (SettingsAudio) SettingsList.addSetting(new SettingsAudio("GPS_fix", SettingCategory.Sounds, NEVER, new Audio("data/sound/GPS_Fix.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB));
