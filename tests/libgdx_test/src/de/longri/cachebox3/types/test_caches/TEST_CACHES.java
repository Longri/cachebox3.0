...
public class TEST_CACHES {
    ...
    public final static AbstractTestCache GC2V0NP = new TestCache_GC2V0NP();
    public final static AbstractTestCache OCF19A= new TestCache_OCF19A();
}
