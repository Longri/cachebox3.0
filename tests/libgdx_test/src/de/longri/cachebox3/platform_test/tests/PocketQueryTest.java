...
public class PocketQueryTest {
    ...
    @Test
    public void getPqListOnlineTest() throws InterruptedException, PlatformAssertionError {
        if (isDummy) return;

        Array<PocketQuery> pqList = new Array<>();
        GetPocketQueryList pq = new GetPocketQueryList(GroundspeakLiveAPI.getUrlCodiert(apiKey), null, pqList);
